...
# Publish the new public avatar image before any Worker starts referencing it.
(cd apps/frontend && npx --yes wrangler@4.126.0 pages deploy dist --project-name buddys --branch main)
